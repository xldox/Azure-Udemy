...
exec >> /var/bi-etl/five9/logs/log_run_sh_pipeline_chat.txt 2>&1
...
echo "Rodando o ETL: /root/.local/bin/poetry run python3 -m src.pipeline_chat 5"
/root/.local/bin/poetry run python3 -m src.pipeline_chat 5
