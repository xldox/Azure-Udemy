...
sql_query =  """
select max(DataHora) from CentralAssinante_v2.chamados_app_novo;
"""

sql_query1 = text("SELECT MAX(DataHora) FROM CentralAssinante_v2.chamados_app_novo;")


with engine.connect() as conn:
    result = conn.execute(sql_query1)
    max_data_hora = result.scalar()



print("Resultado da consulta:", max_data_hora)
...
print(result)
print('AQUI RESULTADO DE DATA',data)
